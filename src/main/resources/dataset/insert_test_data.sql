INSERT INTO public.address (dtype, l1, l2, l3, l4, l5, l6, l7) VALUES ('InseeAddress', 'Ted Farmer' ,'','','1 rue de la gare' ,'','29270 Carhaix' ,'France');
INSERT INTO public.address (dtype, l1, l2, l3, l4, l5, l6, l7) VALUES ('InseeAddress', 'Cecilia Ortega' ,'','','2 place de la mairie' ,'','90000 Belfort' ,'France');
INSERT INTO public.address (dtype, l1, l2, l3, l4, l5, l6, l7) VALUES ('InseeAddress', 'Claude Watkins' ,'','','3 avenue de la République' ,'','32230 Marciac' ,'France');
INSERT INTO public.address (dtype, l1, l2, l3, l4, l5, l6, l7) VALUES ('InseeAddress', 'Veronica Gill' ,'','','4 chemin du ruisseau' ,'','44190 Clisson' ,'France');
INSERT INTO public.address (dtype, l1, l2, l3, l4, l5, l6, l7) VALUES ('InseeAddress', 'Christine Aguilar' ,'','','5 rue de l''école' ,'','59620 Aulnoye-Aimeries' ,'France');
INSERT INTO public.address (dtype, l1, l2, l3, l4, l5, l6, l7) VALUES ('InseeAddress', 'Louise Walker' ,'','','6 impasse du lac' ,'','38200 Vienne' ,'France');
INSERT INTO public.address (dtype, l1, l2, l3, l4, l5, l6, l7) VALUES ('InseeAddress', 'Anthony Bennett' ,'','','7 avenue de la Liberté' ,'','62000 Arras' ,'France');
INSERT INTO public.address (dtype, l1, l2, l3, l4, l5, l6, l7) VALUES ('InseeAddress', 'Christopher Lewis' ,'','','8 route du moulin' ,'','35000 Rennes' ,'France');
INSERT INTO public.address (dtype, l1, l2, l3, l4, l5, l6, l7) VALUES ('InseeAddress', 'Laurent Neville' ,'','','5 route du sapin' ,'','35000 Rennes' ,'France');
...
INSERT INTO public.visibility(organization_unit_id, campaign_id, collection_end_date, collection_start_date, end_date, identification_phase_start_date, interviewer_start_date, management_start_date) VALUES ('OU-NORTH', 'SIMPSONS2020X00',  101010101, 101010101, 101010101, 101010101, 101010101, 101010101);
INSERT INTO public.visibility(organization_unit_id, campaign_id, collection_end_date, collection_start_date, end_date, identification_phase_start_date, interviewer_start_date, management_start_date) VALUES ('OU-NORTH', 'VQS2021X00',   101010101, 101010101, 101010101, 101010101, 101010101, 101010101);
INSERT INTO public.visibility(organization_unit_id, campaign_id, collection_end_date, collection_start_date, end_date, identification_phase_start_date, interviewer_start_date, management_start_date) VALUES ('OU-SOUTH', 'VQS2021X00',  101010101, 101010101, 101010101, 101010101, 101010101, 101010101);
INSERT INTO public.visibility(organization_unit_id, campaign_id, collection_end_date, collection_start_date, end_date, identification_phase_start_date, interviewer_start_date, management_start_date) VALUES ('OU-SOUTH', 'SIMPSONS2020X00',  101010101, 101010101, 101010101, 101010101, 101010101, 101010101);
INSERT INTO public.visibility(organization_unit_id, campaign_id, collection_end_date, collection_start_date, end_date, identification_phase_start_date, interviewer_start_date, management_start_date) VALUES ('OU-SOUTH', 'ZCLOSEDX00',  101010101, 101010101, 101010101, 101010101, 101010101, 101010101);
INSERT INTO public.visibility(organization_unit_id, campaign_id, collection_end_date, collection_start_date, end_date, identification_phase_start_date, interviewer_start_date, management_start_date) VALUES ('OU-WEST', 'ZCLOSEDX00',  101010101, 101010101, 101010101, 101010101, 101010101, 101010101);
INSERT INTO public.visibility(organization_unit_id, campaign_id, collection_end_date, collection_start_date, end_date, identification_phase_start_date, interviewer_start_date, management_start_date) VALUES ('OU-SOUTH', 'XCLOSEDX00',  101010101, 101010101, 101010101, 101010101, 101010101, 101010101);
...
INSERT INTO public.closing_cause (date, type, survey_unit_id) VALUES (101010101, 'NPI', '11');

INSERT INTO public.referent (first_name, last_name, role,phone_number, campaign_id) VALUES ('Eddie', 'Larsen', 'PRIMARY', '+33987654321','SIMPSONS2020X00');
INSERT INTO public.referent (first_name, last_name, role,phone_number, campaign_id) VALUES ('Georges', 'Seacoal', 'PRIMARY', '+33987654321','VQS2021X00');
INSERT INTO public.referent (first_name, last_name, role,phone_number, campaign_id) VALUES ('Silvius', 'Shepherd', 'PRIMARY', '+33987654321','ZCLOSEDX00');
INSERT INTO public.referent (first_name, last_name, role,phone_number, campaign_id) VALUES ('Titus', 'Andronicus', 'PRIMARY', '+33987654321','XCLOSEDX00');
